...
@Mod("animecrossworkspace")
public class AnimecrossworkspaceMod {
	public static final Logger LOGGER = LogManager.getLogger(AnimecrossworkspaceMod.class);
	public static final String MODID = "animecrossworkspace";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION,
			PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public AnimecrossworkspaceMod() {
		AnimecrossworkspaceModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		AnimecrossworkspaceModBlocks.REGISTRY.register(bus);
		AnimecrossworkspaceModItems.REGISTRY.register(bus);
		AnimecrossworkspaceModEntities.REGISTRY.register(bus);

		AnimecrossworkspaceModFeatures.REGISTRY.register(bus);

		AnimecrossworkspaceModMobEffects.REGISTRY.register(bus);
