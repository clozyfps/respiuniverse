...
public class AnnihilationTypeRightclickedProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if ((entity.getCapability(AnimecrossworkspaceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				&& (entity.getCapability(AnimecrossworkspaceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new AnimecrossworkspaceModVariables.PlayerVariables())).level >= 40
				&& (entity.getCapability(AnimecrossworkspaceModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				_player.getCooldowns().addCooldown(itemstack.getItem(), 1000);
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, entity, 35, 1, (byte) 1);
