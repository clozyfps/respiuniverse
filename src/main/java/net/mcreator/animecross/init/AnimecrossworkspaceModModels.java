...
import net.mcreator.animecross.client.model.Modelpower;
import net.mcreator.animecross.client.model.Modelpochitafixed;
...
public class AnimecrossworkspaceModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(Modelpowerhorn.LAYER_LOCATION, Modelpowerhorn::createBodyLayer);
		event.registerLayerDefinition(Modelpochita.LAYER_LOCATION, Modelpochita::createBodyLayer);
		...
		event.registerLayerDefinition(Modelpochitaentyty.LAYER_LOCATION, Modelpochitaentyty::createBodyLayer);
		...
		event.registerLayerDefinition(Modelpochitafixed.LAYER_LOCATION, Modelpochitafixed::createBodyLayer);
		...
		event.registerLayerDefinition(Modelpower.LAYER_LOCATION, Modelpower::createBodyLayer);
