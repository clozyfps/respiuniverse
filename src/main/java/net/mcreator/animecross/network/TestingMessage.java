...
import net.mcreator.animecross.procedures.StringAdd1Procedure;
...
public class TestingMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			StringAdd1Procedure.execute(world, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		AnimecrossworkspaceMod.addNetworkMessage(TestingMessage.class, TestingMessage::buffer, TestingMessage::new, TestingMessage::handler);
	}
}
