...
public class DisplaySelfEvilSpiritMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AnimecrossworkspaceMod.addNetworkMessage(DisplaySelfEvilSpiritMessage.class, DisplaySelfEvilSpiritMessage::buffer,
				DisplaySelfEvilSpiritMessage::new, DisplaySelfEvilSpiritMessage::handler);
	}
}
