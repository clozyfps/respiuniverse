...
import net.mcreator.animecross.procedures.UseAbilityOnKeyPressedProcedure;
...
public class UseAbilityMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		AnimecrossworkspaceMod.addNetworkMessage(UseAbilityMessage.class, UseAbilityMessage::buffer, UseAbilityMessage::new,
				UseAbilityMessage::handler);
	}
}
