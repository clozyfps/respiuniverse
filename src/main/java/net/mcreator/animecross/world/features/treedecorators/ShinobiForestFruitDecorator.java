...
public class ShinobiForestFruitDecorator extends CocoaDecorator {
	public static final ShinobiForestFruitDecorator INSTANCE = new ShinobiForestFruitDecorator();
	public static com.mojang.serialization.Codec<ShinobiForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("shinobi_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ShinobiForestFruitDecorator() {
		super(0.2f);
	}
