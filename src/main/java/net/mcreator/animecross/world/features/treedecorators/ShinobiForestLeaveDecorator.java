...
public class ShinobiForestLeaveDecorator extends LeaveVineDecorator {
	public static final ShinobiForestLeaveDecorator INSTANCE = new ShinobiForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("shinobi_forest_tree_leave_decorator");
