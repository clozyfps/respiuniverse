...
public class VolcanicGrandMagicZoneLeaveDecorator extends LeaveVineDecorator {
	public static final VolcanicGrandMagicZoneLeaveDecorator INSTANCE = new VolcanicGrandMagicZoneLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("volcanic_grand_magic_zone_tree_leave_decorator");
