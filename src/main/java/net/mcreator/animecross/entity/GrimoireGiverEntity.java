...
import net.mcreator.animecross.procedures.GrimoireGiverRightClickedOnEntityProcedure;
...
public class GrimoireGiverEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.GRIMOIRE_GIVER.get(), 20, 4, 4));
	}

	public GrimoireGiverEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.GRIMOIRE_GIVER.get(), world);
	}

	public GrimoireGiverEntity(EntityType<GrimoireGiverEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("(Grimoire Giver)"));
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GrimoireGiverRightClickedOnEntityProcedure.execute(sourceentity);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.GRIMOIRE_GIVER.get(), SpawnPlacements.Type.ON_GROUND,
