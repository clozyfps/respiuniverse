...
public class AllMightEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.ALL_MIGHT.get(), 1, 1, 1));
	}

	public AllMightEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.ALL_MIGHT.get(), world);
	}

	public AllMightEntity(EntityType<AllMightEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		AllMightOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
