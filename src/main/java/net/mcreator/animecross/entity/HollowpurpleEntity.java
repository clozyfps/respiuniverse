...
public class HollowpurpleEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		HollowpurpleProjectileHitsBlockProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		HollowpurpleProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(),
	...
	public static HollowpurpleEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		HollowpurpleEntity entityarrow = new HollowpurpleEntity(AnimecrossworkspaceModEntities.HOLLOWPURPLE.get(), entity, world);
	...
	public static HollowpurpleEntity shoot(LivingEntity entity, LivingEntity target) {
		HollowpurpleEntity entityarrow = new HollowpurpleEntity(AnimecrossworkspaceModEntities.HOLLOWPURPLE.get(), entity, entity.level);
