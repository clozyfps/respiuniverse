...
public class MahitoEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.MAHITO.get(), 1, 1, 1));
	}

	public MahitoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.MAHITO.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.MAHITO.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MahitoEntity.RemovalReason.KILLED);
		}
	}
