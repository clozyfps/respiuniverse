...
public class SilverFangDojoStudentEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public SilverFangDojoStudentEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.SILVER_FANG_DOJO_STUDENT.get(), world);
	}

	public SilverFangDojoStudentEntity(EntityType<SilverFangDojoStudentEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SilverFangDojoStudentEntity.RemovalReason.KILLED);
		}
	}
