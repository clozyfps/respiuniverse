...
import net.mcreator.animecross.procedures.StrongGoblinOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class StrongGoblinEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.STRONG_GOBLIN.get(), 12, 1, 5));
	}

	public StrongGoblinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.STRONG_GOBLIN.get(), world);
	}

	public StrongGoblinEntity(EntityType<StrongGoblinEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		StrongGoblinOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.STRONG_GOBLIN.get(), SpawnPlacements.Type.ON_GROUND,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(StrongGoblinEntity.RemovalReason.KILLED);
		}
	}
