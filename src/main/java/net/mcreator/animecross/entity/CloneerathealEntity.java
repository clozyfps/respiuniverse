...
import net.mcreator.animecross.procedures.CloneerathealOnInitialEntitySpawnProcedure;
...
public class CloneerathealEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public CloneerathealEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.CLONEERATHEAL.get(), world);
	}

	public CloneerathealEntity(EntityType<CloneerathealEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		CloneerathealOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CloneerathealEntity retval = AnimecrossworkspaceModEntities.CLONEERATHEAL.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CloneerathealEntity.RemovalReason.KILLED);
		}
	}
