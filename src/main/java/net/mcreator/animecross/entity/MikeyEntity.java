...
public class MikeyEntity extends Monster implements IAnimatable {
	...
	public MikeyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.MIKEY.get(), world);
	}

	public MikeyEntity(EntityType<MikeyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, AmbientCreature.class, true, true));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AnimecrossworkspaceModItems.WHITE_MIKEY_CLOAK_CHESTPLATE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.MIKEY.get(), SpawnPlacements.Type.ON_GROUND,
