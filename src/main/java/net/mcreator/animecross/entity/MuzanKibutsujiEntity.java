...
import net.mcreator.animecross.procedures.YahabaOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.procedures.YahabaOnEntityTickUpdateProcedure;
import net.mcreator.animecross.procedures.MuzanKibutsujiRightClickedOnEntityProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class MuzanKibutsujiEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.MUZAN_KIBUTSUJI.get(), 1, 1, 1));
	}

	public MuzanKibutsujiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.MUZAN_KIBUTSUJI.get(), world);
	}

	public MuzanKibutsujiEntity(EntityType<MuzanKibutsujiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		YahabaOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MuzanKibutsujiRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.MUZAN_KIBUTSUJI.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MuzanKibutsujiEntity.RemovalReason.KILLED);
		}
	}
