...
public class SandShinobiEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.AMBIENT)
					.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.SAND_SHINOBI.get(), 2, 1, 5));
	}

	public SandShinobiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.SAND_SHINOBI.get(), world);
	}

	public SandShinobiEntity(EntityType<SandShinobiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.SAND_SHINOBI.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SandShinobiEntity.RemovalReason.KILLED);
		}
	}
