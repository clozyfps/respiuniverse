...
import net.mcreator.animecross.procedures.AkazaEntityIsHurtProcedure;
import net.mcreator.animecross.procedures.AkazaEntityDiesProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class AkazaEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.AKAZA.get(), 1, 1, 1));
	}

	public AkazaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.AKAZA.get(), world);
	}

	public AkazaEntity(EntityType<AkazaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		AkazaEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.AKAZA.get(), SpawnPlacements.Type.ON_GROUND,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AkazaEntity.RemovalReason.KILLED);
		}
	}
