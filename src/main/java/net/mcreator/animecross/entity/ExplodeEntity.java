...
import net.mcreator.animecross.procedures.ExplodeProjectileHitsLivingEntityProcedure;
...
public class ExplodeEntity extends AbstractArrow implements ItemSupplier {
	public ExplodeEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(AnimecrossworkspaceModEntities.EXPLODE.get(), world);
	}
	...
	public void playerTouch(Player entity) {
		...
		ExplodeProjectileHitsLivingEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	public static ExplodeEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		ExplodeEntity entityarrow = new ExplodeEntity(AnimecrossworkspaceModEntities.EXPLODE.get(), entity, world);
	...
	public static ExplodeEntity shoot(LivingEntity entity, LivingEntity target) {
		ExplodeEntity entityarrow = new ExplodeEntity(AnimecrossworkspaceModEntities.EXPLODE.get(), entity, entity.level);
