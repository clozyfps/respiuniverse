...
import net.mcreator.animecross.procedures.MegumiFushiguroEntityIsHurtProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

@Mod.EventBusSubscriber
public class MegumiFushiguroEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.MEGUMI_FUSHIGURO.get(), 1, 1, 1));
	}

	public MegumiFushiguroEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.MEGUMI_FUSHIGURO.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		MegumiFushiguroEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
		return super.hurt(source, amount);
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.MEGUMI_FUSHIGURO.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 196);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MegumiFushiguroEntity.RemovalReason.KILLED);
		}
	}
