...
public class NarutocloneEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public NarutocloneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.NARUTOCLONE.get(), world);
	}

	public NarutocloneEntity(EntityType<NarutocloneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SasukeUchihaEntity.class, true, true));
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(NarutocloneEntity.RemovalReason.KILLED);
		}
	}
