...
public class IchigoEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.ICHIGO.get(), 1, 1, 1));
	}

	public IchigoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.ICHIGO.get(), world);
	}
	...
	public IchigoEntity(EntityType<IchigoEntity> type, Level world) {
		...
		xpReward = 5;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(AnimecrossworkspaceModItems.ICHIGO_ZANPAKUTO.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.ICHIGO.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(IchigoEntity.RemovalReason.KILLED);
		}
	}
