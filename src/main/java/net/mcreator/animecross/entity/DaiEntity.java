...
import net.mcreator.animecross.procedures.DaiEntityDiesProcedure;
...
public class DaiEntity extends Monster {
	...
	public DaiEntity(EntityType<DaiEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(AnimecrossworkspaceModItems.SWORD_OF_DAI.get()));
	}
