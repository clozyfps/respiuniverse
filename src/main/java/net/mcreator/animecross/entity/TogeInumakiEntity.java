...
import net.mcreator.animecross.procedures.TogeInumakiEntityIsHurtProcedure;
import net.mcreator.animecross.procedures.TogeInumakiEntityDiesProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModItems;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

@Mod.EventBusSubscriber
public class TogeInumakiEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.TOGE_INUMAKI.get(), 2, 1, 1));
	}

	public TogeInumakiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.TOGE_INUMAKI.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AnimecrossworkspaceModItems.SLEEPITEM.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		TogeInumakiEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public void die(DamageSource source) {
		super.die(source);
		TogeInumakiEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.TOGE_INUMAKI.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(TogeInumakiEntity.RemovalReason.KILLED);
		}
	}
