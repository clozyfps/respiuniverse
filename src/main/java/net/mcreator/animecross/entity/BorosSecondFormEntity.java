...
import net.mcreator.animecross.procedures.BorosSecondFormEntityDiesProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

public class BorosSecondFormEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public BorosSecondFormEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.BOROS_SECOND_FORM.get(), world);
	}

	public BorosSecondFormEntity(EntityType<BorosSecondFormEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		BorosSecondFormEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BorosSecondFormEntity.RemovalReason.KILLED);
		}
	}
