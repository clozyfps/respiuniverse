...
import net.mcreator.animecross.procedures.ItadoriOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.procedures.ItadoriEntityIsHurtProcedure;
import net.mcreator.animecross.procedures.ItadoriEntityDiesProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class ItadoriEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.ITADORI.get(), 1, 1, 1));
	}

	public ItadoriEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.ITADORI.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		ItadoriEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.ITADORI.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ItadoriEntity.RemovalReason.KILLED);
		}
	}
