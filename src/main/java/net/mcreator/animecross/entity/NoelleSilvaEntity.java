...
import net.mcreator.animecross.procedures.NoelleSilvaEntityDiesProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModItems;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

@Mod.EventBusSubscriber
public class NoelleSilvaEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.NOELLE_SILVA.get(), 1, 1, 1));
	}

	public NoelleSilvaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.NOELLE_SILVA.get(), world);
	}

	public NoelleSilvaEntity(EntityType<NoelleSilvaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		NoelleSilvaEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.NOELLE_SILVA.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.MAX_HEALTH, 149);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(NoelleSilvaEntity.RemovalReason.KILLED);
		}
	}
