...
import net.mcreator.animecross.procedures.SukunaOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

public class SukunaEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public SukunaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.SUKUNA.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		SukunaOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SukunaEntity.RemovalReason.KILLED);
		}
	}
