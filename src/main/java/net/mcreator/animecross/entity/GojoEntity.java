...
import net.mcreator.animecross.procedures.GojoRightClickedOnEntityProcedure;
import net.mcreator.animecross.procedures.GojoOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.procedures.GojoEntityIsHurtProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class GojoEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.GOJO.get(), 1, 1, 1));
	}

	public GojoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.GOJO.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		GojoEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		GojoOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GojoRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.GOJO.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(GojoEntity.RemovalReason.KILLED);
		}
	}
