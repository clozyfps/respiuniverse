...
import net.mcreator.animecross.procedures.SonGokuOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.procedures.SonGokuOnEntityTickUpdateProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

@Mod.EventBusSubscriber
public class SonGokuEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT)
				.add(new MobSpawnSettings.SpawnerData(AnimecrossworkspaceModEntities.SON_GOKU.get(), 1, 1, 1));
	}

	public SonGokuEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.SON_GOKU.get(), world);
	}

	public SonGokuEntity(EntityType<SonGokuEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		SonGokuOnEntityTickUpdateProcedure.execute(this);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		SonGokuOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(AnimecrossworkspaceModEntities.SON_GOKU.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(SonGokuEntity.RemovalReason.KILLED);
		}
	}
