...
import net.mcreator.animecross.procedures.WhiteDivineDogOnInitialEntitySpawnProcedure;
...
public class WhiteDivineDogEntity extends TamableAnimal implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public WhiteDivineDogEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.WHITE_DIVINE_DOG.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomStrollGoal(this, 1.6));
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		WhiteDivineDogOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WhiteDivineDogEntity retval = AnimecrossworkspaceModEntities.WHITE_DIVINE_DOG.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WhiteDivineDogEntity.RemovalReason.KILLED);
		}
	}
