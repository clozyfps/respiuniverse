...
import net.mcreator.animecross.procedures.CosmicFearGarouOnInitialEntitySpawnProcedure;
import net.mcreator.animecross.procedures.CosmicFearGarouEntityIsHurtProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModEntities;

import javax.annotation.Nullable;

public class CosmicFearGarouEntity extends Monster implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);
	private boolean swinging;
	private long lastSwing;

	public CosmicFearGarouEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossworkspaceModEntities.COSMIC_FEAR_GAROU.get(), world);
	}

	public CosmicFearGarouEntity(EntityType<CosmicFearGarouEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		CosmicFearGarouEntityIsHurtProcedure.execute(this);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		CosmicFearGarouOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CosmicFearGarouEntity.RemovalReason.KILLED);
		}
	}
