...
import net.mcreator.animecross.procedures.ConnectBBGProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class EntityDMobEffect extends MobEffect {
	public EntityDMobEffect() {
		super(MobEffectCategory.NEUTRAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.entity_d";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		ConnectBBGProcedure.execute(entity.level, entity.getX(), entity.getY(), entity.getZ(), entity);
	}
