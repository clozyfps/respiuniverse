...
import net.mcreator.animecross.procedures.DemonKingOnEffectActiveTickProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class DemonKingMobEffect extends MobEffect {
	public DemonKingMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.demon_king";
	}

	@Override
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		DemonKingOnEffectActiveTickProcedure.execute(entity.level, entity);
	}
