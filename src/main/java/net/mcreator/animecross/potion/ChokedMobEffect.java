...
import net.mcreator.animecross.procedures.ChokingStringProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class ChokedMobEffect extends MobEffect {
	public ChokedMobEffect() {
		super(MobEffectCategory.NEUTRAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.choked";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		ChokingStringProcedure.execute(entity.level, entity.getX(), entity.getY(), entity.getZ(), entity);
	}
