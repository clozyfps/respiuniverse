...
import net.mcreator.animecross.procedures.SupremeTickProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class SupremeDeityMobEffect extends MobEffect {
	public SupremeDeityMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.supreme_deity";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		SupremeTickProcedure.execute(entity.level, entity);
	}
