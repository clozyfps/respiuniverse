...
import net.mcreator.animecross.procedures.ArchAngelProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class ArchAngelPotionMobEffect extends MobEffect {
	public ArchAngelPotionMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.arch_angel_potion";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		ArchAngelProcedure.execute(entity);
	}
