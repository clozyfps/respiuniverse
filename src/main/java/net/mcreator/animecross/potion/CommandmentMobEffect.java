...
import net.mcreator.animecross.procedures.CommandmentTickProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class CommandmentMobEffect extends MobEffect {
	public CommandmentMobEffect() {
		super(MobEffectCategory.BENEFICIAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.animecrossworkspace.commandment";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		CommandmentTickProcedure.execute(entity);
	}
