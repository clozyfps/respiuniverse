...
public class PirateRenderer extends HumanoidMobRenderer<PirateEntity, HumanoidModel<PirateEntity>> {
	...
	public ResourceLocation getTextureLocation(PirateEntity entity) {
		return new ResourceLocation("animecrossworkspace:textures/entities/pirate_barbe.png");
	}
}
