...
public class HanamiRenderer extends GeoEntityRenderer<HanamiEntity> {
	public HanamiRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new HanamiModelProcedure());
		this.shadowRadius = 0.5f;
	}

	@Override
	public RenderType getRenderType(HanamiEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer,
