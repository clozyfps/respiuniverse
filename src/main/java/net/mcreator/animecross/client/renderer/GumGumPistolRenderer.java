...
public class GumGumPistolRenderer extends EntityRenderer<GumGumPistolEntity> {
	...
	public GumGumPistolRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelluffyfist(context.bakeLayer(Modelluffyfist.LAYER_LOCATION));
	}

	@Override
	public void render(GumGumPistolEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(GumGumPistolEntity entity) {
		return texture;
	}
}
