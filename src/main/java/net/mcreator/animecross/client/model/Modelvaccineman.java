...
public class Modelvaccineman<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelvaccineman"),
			"main");
	...
	public Modelvaccineman(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition antenna = Head.addOrReplaceChild("antenna", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 11.0F));
		PartDefinition cube_r1 = antenna.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.3137F, -6.1326F, -19.1715F, 0.2967F, -0.3927F, 0.0F));
		PartDefinition cube_r2 = antenna.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -6.3125F, -16.0F, 0.0524F, -0.3927F, 0.0F));
		PartDefinition cube_r3 = antenna.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8447F, -6.0684F, -19.3878F, 0.2967F, 0.2443F, 0.0F));
		PartDefinition cube_r4 = antenna.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -6.3125F, -16.0F, 0.0698F, 0.2443F, 0.0F));
