...
public class Modelmarinered<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelmarinered"),
			"main");
	public final ModelPart Marinecaptaincape;
	public final ModelPart rightarm;
	public final ModelPart leftarm;

	public Modelmarinered(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Marinecaptaincape = partdefinition.addOrReplaceChild("Marinecaptaincape", CubeListBuilder.create(),
				PartPose.offset(0.0F, 23.5F, 0.0F));
		PartDefinition shoulders = Marinecaptaincape.addOrReplaceChild(
				"shoulders", CubeListBuilder.create().texOffs(14, 17).addBox(5.0F, -24.1875F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(0, 17).addBox(-7.875F, -24.1875F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cape = Marinecaptaincape.addOrReplaceChild("cape", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r1 = cape.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(54, 14).addBox(-8.25F, -11.5F, -2.0F, 3.0F, 20.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 39)
		...
		PartDefinition Arms = Marinecaptaincape.addOrReplaceChild("Arms", CubeListBuilder.create(), PartPose.offset(-0.1875F, -13.4691F, 7.2295F));
		...
		PartDefinition cube_r2 = Arm1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(23, 23).addBox(-2.5625F, -0.375F, -5.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition cube_r3 = Arm1.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(24, 19).addBox(-0.25F, 1.875F, -5.875F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
		...
		PartDefinition cube_r4 = Arm1.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(14, 0).addBox(-1.3125F, -5.625F, -1.5F, 4.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Arm2.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(12, 24).addBox(0.375F, 5.625F, -2.375F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 17)
		...
		PartDefinition cube_r6 = Arm2.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 22).addBox(-2.375F, -0.5F, -0.4375F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Arm2.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(12, 22).addBox(-1.875F, -0.5F, -0.625F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
