...
public class Modelfireballjutsudra<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("animecrossworkspace", "modelfireballjutsudra"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 6).addBox(-1.0F, -18.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(12.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 24).addBox(-7.0F, -25.0F, -22.0F, 15.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-7.0F, -27.0F, -22.0F, 15.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(44, 10).addBox(-7.0F, -7.0F, -28.0F, 15.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(44, 26)
