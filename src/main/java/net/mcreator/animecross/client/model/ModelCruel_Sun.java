...
public class ModelCruel_Sun<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "model_cruel_sun"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(24, 38).addBox(-26.0F, -29.0F, -7.1875F, 32.0F, 32.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(24, 18).addBox(-26.0F, -28.0F, -8.625F, 32.0F, 31.0F, 23.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
