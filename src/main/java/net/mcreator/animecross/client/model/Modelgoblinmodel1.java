...
public class Modelgoblinmodel1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelgoblinmodel_1"),
			"main");
	public final ModelPart Leftarm;
	public final ModelPart Head;
	public final ModelPart Rightarfm;
	public final ModelPart cloak;
	public final ModelPart Body;
	public final ModelPart rightleg;
	public final ModelPart leftleg;
	public final ModelPart goblinmodel;

	public Modelgoblinmodel1(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leftarm = partdefinition.addOrReplaceChild("Leftarm",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.75F, -7.1875F, -0.3125F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Head = partdefinition.addOrReplaceChild(
				"Head", CubeListBuilder.create().texOffs(0, 4).addBox(-1.375F, -9.75F, -1.4375F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-0.3125F, -8.4375F, -1.8125F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Rightarfm = partdefinition.addOrReplaceChild("Rightarfm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.9375F, -6.375F, -0.3125F, 0.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cloak = partdefinition.addOrReplaceChild("cloak",
				CubeListBuilder.create().texOffs(5, 14).addBox(-2.724F, -0.8208F, 0.9688F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(7, 14)
		...
		PartDefinition cube_r1 = cloak.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(6, 15).addBox(-1.0F, -0.9063F, 0.0625F, 2.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, -0.2618F));
		PartDefinition cube_r2 = cloak.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(6, 14).addBox(-1.0313F, -0.6875F, -0.0625F, 2.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8802F, -0.1333F, 0.0313F, 0.0F, -1.5708F, 0.1222F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.125F, -7.4375F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 4)
		...
		PartDefinition rightleg = partdefinition.addOrReplaceChild("rightleg",
				CubeListBuilder.create().texOffs(0, 3).addBox(-1.4375F, -3.4375F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition leftleg = partdefinition.addOrReplaceChild("leftleg",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.375F, -0.5F, -0.8125F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
				...
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition goblinmodel = partdefinition.addOrReplaceChild("goblinmodel", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
