...
public class ModelFireForceChest<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("animecrossworkspace", "model_fire_force_chest"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.25F)).texOffs(19, 0)
		...
		PartDefinition BodyLayer_r1 = Body.addOrReplaceChild("BodyLayer_r1",
				CubeListBuilder.create().texOffs(13, 21).addBox(-3.0F, -0.2662F, 0.2584F, 6.0F, 0.0F, 1.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition BodyLayer_r2 = Body.addOrReplaceChild("BodyLayer_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, 0.25F, 6.0F, 0.0F, 0.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition BodyLayer_r4 = Body.addOrReplaceChild("BodyLayer_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.25F, -1.4351F, 0.2855F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(0, 1)
		...
		PartDefinition BodyLayer_r5 = Body.addOrReplaceChild("BodyLayer_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.25F, 0.0F, 0.25F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.25F)).texOffs(0, 1)
		...
		PartDefinition BodyLayer_r6 = Body.addOrReplaceChild("BodyLayer_r6",
				CubeListBuilder.create().texOffs(11, 18).addBox(-3.0F, 0.0F, 0.25F, 6.0F, 0.0F, 3.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.0F, -0.5F, 3.25F, -1.5708F, 0.0F, 0.0F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild(
				"RightArm", CubeListBuilder.create().texOffs(20, 18).addBox(-3.75F, -0.75F, -3.0F, 4.0F, 11.0F, 6.0F, new CubeDeformation(0.25F))
						.texOffs(24, 3).addBox(-3.5F, 10.75F, -2.0F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(-4.25F, 0.75F, 0.0F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild(
				"LeftArm", CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, 0.0F, -3.0F, 4.0F, 11.0F, 6.0F, new CubeDeformation(0.25F))
						.texOffs(24, 10).addBox(-0.25F, 11.5F, -2.0F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.25F)),
