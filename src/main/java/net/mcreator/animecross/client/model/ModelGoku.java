...
public class ModelGoku<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "model_goku"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hair = Head.addOrReplaceChild("hair", CubeListBuilder.create(), PartPose.offset(3.277F, -5.5642F, -5.959F));
		PartDefinition bangs = hair.addOrReplaceChild("bangs", CubeListBuilder.create(), PartPose.offset(-1.75F, 0.0F, 0.0F));
		PartDefinition cube_r1 = bangs.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.8185F, -1.2022F, -1.377F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6632F, 0.1745F, 0.0F));
		PartDefinition cube_r2 = bangs.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 8).addBox(-1.131F, -2.0213F, -0.0401F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0349F, 0.1745F, 0.0F));
		PartDefinition cube_r3 = bangs.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(20, 9).addBox(-0.6932F, -1.3566F, -3.344F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = bangs.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(20, 8).addBox(-1.5625F, -1.0F, -1.1875F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = bangs.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.6563F, -0.2813F, -1.6875F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = bangs.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(20, 9).addBox(-0.3438F, -0.4063F, -1.125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = top.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(20, 9).addBox(-4.2188F, -0.8438F, -1.125F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = top.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(20, 8).addBox(-4.5313F, -0.7188F, -1.6875F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = top.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(20, 8).addBox(-5.4375F, -1.4375F, -1.1875F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = top.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(20, 8).addBox(-1.75F, -1.4375F, -1.1875F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = top.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(20, 9).addBox(-0.5313F, -0.8438F, -1.125F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = top.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.8438F, -0.7188F, -1.6875F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9232F, 0.7689F, -0.7688F, 0.6632F, 0.3491F, 0.0F));
		PartDefinition sides = hair.addOrReplaceChild("sides", CubeListBuilder.create(), PartPose.offset(-4.7281F, -2.9668F, 3.9993F));
		PartDefinition cube_r19 = sides.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.6485F, -1.8564F, -3.3441F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(20, 8).addBox(-0.7139F, 0.2419F, -2.6803F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 8)
		...
		PartDefinition cube_r20 = sides.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(20, 8).addBox(-1.0019F, -1.8354F, -1.3415F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(20, 8).addBox(-1.0673F, 0.0196F, -0.1572F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 8)
		...
		PartDefinition cube_r21 = sides.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.8486F, -0.7361F, -0.7132F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = sides.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.4952F, -0.632F, -3.0217F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = sides.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(20, 8).addBox(-1.0673F, 0.0196F, -0.1572F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(20, 8).addBox(-1.0019F, -1.8354F, -1.3415F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = sides.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(20, 8).addBox(-0.7139F, 0.2419F, -2.6803F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(20, 8).addBox(-0.6485F, -1.8564F, -3.3441F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
