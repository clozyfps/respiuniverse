...
public class Modelkizaru<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelkizaru"),
			"main");
	public final ModelPart sunglasses;
	public final ModelPart head;
	public final ModelPart cape2;
	public final ModelPart Rightarn;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(24, 37).addBox(-1.125F, -24.3125F, -1.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition shoulders = Marinecaptaincape.addOrReplaceChild("shoulders", CubeListBuilder.create(), PartPose.offset(0.0F, -0.5F, 0.0F));
		PartDefinition cape = Marinecaptaincape.addOrReplaceChild("cape", CubeListBuilder.create(), PartPose.offset(0.0F, 1.0625F, -4.5625F));
		PartDefinition cube_r1 = cape.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 21).addBox(-7.0F, -11.5F, -3.5F, 2.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 21)
		...
		PartDefinition Arms = Marinecaptaincape.addOrReplaceChild("Arms", CubeListBuilder.create(), PartPose.offset(-0.375F, -13.9691F, 7.2295F));
		...
		PartDefinition cube_r2 = Arm1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 21).addBox(-10.3125F, -1.3125F, 7.4375F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Arm2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(16, 21).addBox(4.875F, -4.25F, 8.125F, 2.0F, 14.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Rightarn = partdefinition.addOrReplaceChild("Rightarn",
				CubeListBuilder.create().texOffs(16, 37).addBox(-4.6875F, -21.8125F, -0.8125F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(6, 21).addBox(-4.875F, -12.25F, -0.9375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Leftarm = partdefinition.addOrReplaceChild(
				"Leftarm", CubeListBuilder.create().texOffs(6, 21).addBox(3.125F, -12.25F, -0.9375F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(16, 37).addBox(3.3125F, -21.8125F, -0.8125F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Leftleg = partdefinition.addOrReplaceChild("Leftleg",
				CubeListBuilder.create().texOffs(30, 7).addBox(0.4375F, -10.875F, -1.1875F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(32, 55).addBox(0.4375F, -0.375F, -2.9375F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Rightleg = partdefinition.addOrReplaceChild("Rightleg",
				CubeListBuilder.create().texOffs(32, 19).addBox(-2.5F, -10.875F, -1.1875F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(51, 24).addBox(-2.5F, -0.375F, -2.9375F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild(
				"body", CubeListBuilder.create().texOffs(30, 0).addBox(-3.375F, -21.875F, -1.5F, 6.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(32, 31).addBox(-2.5F, -16.375F, -1.1875F, 4.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
