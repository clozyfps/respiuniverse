...
public class Modelpochitafixed<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelpochitafixed"),
			"main");
	public final ModelPart Chainsaw;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chainsaw = partdefinition.addOrReplaceChild("Chainsaw",
				CubeListBuilder.create().texOffs(0, 14).addBox(-15.4375F, -4.25F, 10.4375F, 0.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(13, 15).addBox(-15.4375F, -4.375F, 12.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(13, 15)
						...
						.addBox(-15.4375F, -3.3125F, 10.75F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(13, 15).addBox(-15.4375F, -3.3125F,
								12.375F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(15.3125F, 20.3125F, -15.8125F));
		PartDefinition cube_r1 = Chainsaw.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(13, 15).addBox(-0.0938F, -0.0313F, -0.0625F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = Chainsaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(13, 15).addBox(-0.0938F, -0.0313F, 0.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Chainsaw.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(13, 15).addBox(-0.0938F, 0.0F, -0.0938F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon = Chainsaw.addOrReplaceChild(
				"hexadecagon", CubeListBuilder.create().texOffs(0, 14).addBox(-7.4375F, 4.1505F, 1.875F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(0, 14).addBox(-7.4375F, 3.75F, 2.2755F, 0.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-8.0F, -8.0F, 8.0F));
		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(0, 14).addBox(-0.5625F, -0.5F, -0.0995F, 0.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
		...
		PartDefinition hexadecagon_r3 = hexadecagon.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(0, 14).addBox(-0.5625F, -0.0995F, -0.5F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(11, 15).addBox(-16.4375F, 3.6875F, 18.0625F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(10, 15).addBox(-16.4172F, 2.8815F, 20.0857F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(16.1875F, 13.5625F, -13.25F));
		PartDefinition cube_r5 = tail.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(10, 15).addBox(-0.0938F, 0.0313F, -0.2188F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = tail.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(10, 15).addBox(-0.0938F, -0.4688F, -0.2188F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(11, 15).addBox(-0.0938F, -0.2813F, -0.4688F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.3438F, 3.7813F, 19.3438F, 0.3927F, 0.0F, 0.0F));
		PartDefinition Leftlegs = partdefinition.addOrReplaceChild(
				"Leftlegs", CubeListBuilder.create().texOffs(9, 2).addBox(-5.8125F, -2.0F, 4.5625F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(6, 1).addBox(-5.8125F, -2.0F, 11.25F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.125F, 23.0625F, -7.5F));
		PartDefinition Rightlegs = partdefinition.addOrReplaceChild("Rightlegs",
				CubeListBuilder.create().texOffs(10, 0).addBox(-17.875F, -2.0F, 11.8125F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 2)
						.addBox(-17.875F, -2.0F, 18.5625F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(15.3125F, 23.0625F, -14.75F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-17.9375F, -7.25F, 11.5625F, 5.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(4, 0)
						.addBox(-13.25F, -9.6875F, 13.8125F, 0.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(6, 14)
						.addBox(-17.875F, -9.6875F, 13.8125F, 5.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(4, 0).addBox(-18.0625F, -9.6875F,
								13.8125F, 0.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(15.3125F, 23.0625F, -14.75F));
