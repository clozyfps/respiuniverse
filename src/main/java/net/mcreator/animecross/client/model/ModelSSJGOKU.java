...
public class ModelSSJGOKU<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "model_ssjgoku"),
			"main");
	...
	public ModelSSJGOKU(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hair = Head.addOrReplaceChild("Hair",
				CubeListBuilder.create().texOffs(32, 0).addBox(-4.004F, -8.0F, -4.004F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch_r1 = bunch.addOrReplaceChild("bunch_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.0297F, -2.4679F, -1.1965F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch_r2 = bunch.addOrReplaceChild("bunch_r2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.6802F, -0.7769F, -1.2595F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch_r3 = bunch.addOrReplaceChild("bunch_r3",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.5983F, -0.3999F, -1.5815F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4931F, -2.7075F, 1.5815F, 0.0F, 0.0F, -0.0654F));
		PartDefinition bunch8 = Left.addOrReplaceChild("bunch8",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.8018F, -0.87F, -0.9009F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch8_r1 = bunch8.addOrReplaceChild("bunch8_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.2973F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.8018F, 1.03F, 0.0F, 0.0F, 0.0F, 0.48F));
		PartDefinition bunch9 = Left.addOrReplaceChild("bunch9",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.8028F, -0.872F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch9_r1 = bunch9.addOrReplaceChild("bunch9_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.973F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, 0.5236F));
		PartDefinition bunch10 = Left.addOrReplaceChild("bunch10",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.8028F, -0.874F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch10_r1 = bunch10.addOrReplaceChild("bunch10_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.4224F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch11_r1 = bunch11.addOrReplaceChild("bunch11_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.5005F, -1.3F, -0.8008F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch11_r2 = bunch11.addOrReplaceChild("bunch11_r2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -0.3408F, -1.2119F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch15 = Left.addOrReplaceChild("bunch15",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -2.968F, -1.001F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch15_r1 = bunch15.addOrReplaceChild("bunch15_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.825F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch17_r1 = bunch17.addOrReplaceChild("bunch17_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -6.4F, -0.4254F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch17_r2 = bunch17.addOrReplaceChild("bunch17_r2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -1.625F, -0.5756F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition bunch18_r1 = bunch18.addOrReplaceChild("bunch18_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.6476F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch19_r1 = bunch19.addOrReplaceChild("bunch19_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-3.1481F, -1.81F, -0.8108F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, 0.829F));
		PartDefinition bunch20 = Left.addOrReplaceChild("bunch20",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.8028F, -0.871F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch20_r1 = bunch20.addOrReplaceChild("bunch20_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-3.2983F, -1.81F, -0.8108F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8028F, 1.029F, 0.0F, 0.0F, 0.0F, 0.6545F));
		PartDefinition bunch31 = Left.addOrReplaceChild("bunch31",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.9009F, -0.874F, 0.2002F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch31_r1 = bunch31.addOrReplaceChild("bunch31_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8108F, 0.19F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.974F, 2.9029F, -0.5672F, 0.0F, 0.0F));
		PartDefinition bunch32 = Left.addOrReplaceChild("bunch32",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.9009F, -0.872F, 0.2002F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch38 = Left.addOrReplaceChild("bunch38",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -2.969F, -1.001F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch38_r1 = bunch38.addOrReplaceChild("bunch38_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.225F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch40_r1 = bunch40.addOrReplaceChild("bunch40_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-2.4474F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch41_r1 = bunch41.addOrReplaceChild("bunch41_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -1.4F, 0.2002F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch46 = Left.addOrReplaceChild("bunch46",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -2.974F, -1.001F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch46_r1 = bunch46.addOrReplaceChild("bunch46_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.0527F, 0.2306F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.974F, -1.001F, -0.2618F, 0.0F, 0.0F));
		PartDefinition bunch48 = Left.addOrReplaceChild("bunch48",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -2.97F, -1.001F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch48_r1 = bunch48.addOrReplaceChild("bunch48_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.025F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch2 = Right.addOrReplaceChild("bunch2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -1.97F, -1.001F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch2_r1 = bunch2.addOrReplaceChild("bunch2_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.9009F, -3.55F, 0.1001F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.97F, -1.001F, -0.48F, 0.0F, 0.0F));
		PartDefinition bunch6 = Right.addOrReplaceChild("bunch6",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -1.97F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r1 = bunch6.addOrReplaceChild("bunch6_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.9009F, -2.45F, 0.1001F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch6_r2 = bunch6.addOrReplaceChild("bunch6_r2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.9009F, -1.7F, 0.1001F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.97F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition bunch7 = Right.addOrReplaceChild("bunch7",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -1.569F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch7_r1 = bunch7.addOrReplaceChild("bunch7_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.7207F, -2.44F, 0.1001F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch12_r1 = bunch12.addOrReplaceChild("bunch12_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.875F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch13_r1 = bunch13.addOrReplaceChild("bunch13_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -3.175F, 0.2002F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.1745F, 0.0F, 0.0F));
		PartDefinition bunch14 = Right.addOrReplaceChild("bunch14",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -1.968F, -1.001F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch14_r1 = bunch14.addOrReplaceChild("bunch14_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.8F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch16_r1 = bunch16.addOrReplaceChild("bunch16_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.85F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch16_r2 = bunch16.addOrReplaceChild("bunch16_r2",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.4F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.968F, -1.001F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition bunch21_r1 = bunch21.addOrReplaceChild("bunch21_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.575F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch22 = Right.addOrReplaceChild("bunch22",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -0.872F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.003F, -4.004F, -2.002F, -0.214F, -0.1766F, -0.7609F));
		PartDefinition bunch22_r1 = bunch22.addOrReplaceChild("bunch22_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -1.81F, -0.8108F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.028F, 0.0F, 0.0F, 0.0F, -0.5236F));
		PartDefinition bunch23 = Right.addOrReplaceChild("bunch23",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -0.874F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch23_r1 = bunch23.addOrReplaceChild("bunch23_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -1.81F, -0.8108F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.8028F, 1.026F, 0.0F, 0.0F, 0.0F, -0.48F));
		PartDefinition bunch24 = Right.addOrReplaceChild("bunch24",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -0.871F, -0.9009F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.003F, -5.005F, 0.0F, 0.1706F, -0.1996F, -0.7153F));
		...
		PartDefinition bunch27 = Right.addOrReplaceChild("bunch27",
				CubeListBuilder.create().texOffs(45, 2).addBox(0.0F, -0.87F, -0.9009F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch33_r1 = bunch33.addOrReplaceChild("bunch33_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.7007F, -5.4F, 0.3003F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch35_r1 = bunch35.addOrReplaceChild("bunch35_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -4.4F, 0.2002F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch36_r1 = bunch36.addOrReplaceChild("bunch36_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -6.65F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch37_r1 = bunch37.addOrReplaceChild("bunch37_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.5F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch44_r1 = bunch44.addOrReplaceChild("bunch44_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -4.075F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch45 = Right.addOrReplaceChild("bunch45",
				CubeListBuilder.create().texOffs(45, 2).addBox(-1.001F, -2.971F, -1.001F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch45_r1 = bunch45.addOrReplaceChild("bunch45_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.7507F, -5.2F, 0.2503F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch47_r1 = bunch47.addOrReplaceChild("bunch47_r1",
				CubeListBuilder.create().texOffs(45, 2).addBox(-0.8008F, -2.375F, 0.2002F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bottom = Bang2.addOrReplaceChild("Bottom",
				CubeListBuilder.create().texOffs(45, 3).addBox(-2.9029F, -31.9F, -6.1561F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Top_r1 = Top.addOrReplaceChild("Top_r1",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.8108F, 0.04F, -2.8979F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch3_r1 = Bottom2.addOrReplaceChild("bunch3_r1",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.9009F, -1.1368F, -0.4433F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch3_r2 = Top2.addOrReplaceChild("bunch3_r2",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.7997F, 0.1388F, -1.8308F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bottom3 = Bang.addOrReplaceChild("Bottom3",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.8008F, -31.8F, -6.4064F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bunch4_r1 = Top3.addOrReplaceChild("bunch4_r1",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.7207F, 0.28F, -2.1622F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bottom4 = Bang3.addOrReplaceChild("Bottom4",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.8008F, -0.769F, -2.4024F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bunch5_r1 = Top4.addOrReplaceChild("bunch5_r1",
				CubeListBuilder.create().texOffs(45, 3).addBox(-0.7207F, 0.0202F, -2.012F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
