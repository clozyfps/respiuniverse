...
public class Modeluzuiarmor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modeluzuiarmor"),
			"main");
	...
	public final ModelPart octagon;
	public final ModelPart octagon4;
	public final ModelPart octagon5;
	public final ModelPart octagon6;
	public final ModelPart octagon7;
	public final ModelPart octagon8;
	public final ModelPart octagon9;
	public final ModelPart octagon10;
	public final ModelPart octagon11;
	public final ModelPart octagon12;
	public final ModelPart octagon13;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition headband = Head.addOrReplaceChild("headband", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition cube_r1 = headband.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 47).addBox(-4.625F, -1.375F, -0.5F, 9.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon14 = headband.addOrReplaceChild("octagon14",
				CubeListBuilder.create().texOffs(58, 37).addBox(0.0F, -0.4142F, -1.0F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(58, 37)
		...
		PartDefinition octagon_r1 = octagon14.addOrReplaceChild("octagon_r1",
				CubeListBuilder.create().texOffs(58, 37).addBox(0.0F, -1.0F, -0.4142F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(58, 37)
		...
		PartDefinition octagon3 = headband.addOrReplaceChild("octagon3",
				CubeListBuilder.create().texOffs(7, 34).addBox(0.25F, 2.8125F, 6.5F, 0.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(8, 34)
		...
		PartDefinition octagon = partdefinition.addOrReplaceChild("octagon",
				CubeListBuilder.create().texOffs(1, 35).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 35)
		...
		PartDefinition octagon_r4 = octagon.addOrReplaceChild("octagon_r4",
				CubeListBuilder.create().texOffs(1, 35).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(1, 35)
		...
		PartDefinition octagon4 = partdefinition.addOrReplaceChild("octagon4",
				CubeListBuilder.create().texOffs(3, 36).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 36)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r5 = octagon4.addOrReplaceChild("octagon_r5",
				CubeListBuilder.create().texOffs(3, 36).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(3, 36)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition octagon5 = partdefinition.addOrReplaceChild("octagon5",
				CubeListBuilder.create().texOffs(3, 38).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 38)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r6 = octagon5.addOrReplaceChild("octagon_r6",
				CubeListBuilder.create().texOffs(3, 38).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(3, 38)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition octagon7 = partdefinition.addOrReplaceChild("octagon7",
				CubeListBuilder.create().texOffs(4, 41).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 41)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r8 = octagon7.addOrReplaceChild("octagon_r8",
				CubeListBuilder.create().texOffs(4, 41).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(4, 41)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition octagon8 = partdefinition.addOrReplaceChild("octagon8",
				CubeListBuilder.create().texOffs(2, 40).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(2, 40)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r9 = octagon8.addOrReplaceChild("octagon_r9",
				CubeListBuilder.create().texOffs(2, 40).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(2, 40)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition octagon9 = partdefinition.addOrReplaceChild("octagon9",
				CubeListBuilder.create().texOffs(4, 39).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 39)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r10 = octagon9.addOrReplaceChild("octagon_r10",
				CubeListBuilder.create().texOffs(4, 39).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(4, 39)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition octagon11 = partdefinition.addOrReplaceChild("octagon11",
				CubeListBuilder.create().texOffs(3, 37).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 37)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r12 = octagon11.addOrReplaceChild("octagon_r12",
				CubeListBuilder.create().texOffs(3, 37).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(3, 37)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition octagon12 = partdefinition.addOrReplaceChild("octagon12",
				CubeListBuilder.create().texOffs(2, 38).addBox(-2.5F, -2.2071F, 1.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(2, 38)
						.addBox(-2.5F, -2.5F, 1.7929F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition octagon_r13 = octagon12.addOrReplaceChild("octagon_r13",
				CubeListBuilder.create().texOffs(2, 38).addBox(-0.5F, -0.5F, -0.2071F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(2, 38)
						.addBox(-0.5F, -0.2071F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
