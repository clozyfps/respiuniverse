...
public class Modelpochita<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("animecrossworkspace", "modelpochita"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chainsaw = partdefinition.addOrReplaceChild("Chainsaw",
				CubeListBuilder.create().texOffs(0, 14).addBox(-15.4375F, -4.25F, 10.4375F, 0.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(14, 13).addBox(-15.4375F, -4.375F, 12.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(14, 13)
						...
						.addBox(-15.4375F, -3.3125F, 10.75F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(14, 13).addBox(-15.4375F, -3.3125F,
		...
		PartDefinition cube_r1 = Chainsaw.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(14, 13).addBox(-0.0938F, -0.0313F, -0.0625F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = Chainsaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(14, 13).addBox(-0.0938F, -0.0313F, 0.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Chainsaw.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(14, 13).addBox(-0.0938F, 0.0F, -0.0938F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail",
				CubeListBuilder.create().texOffs(11, 14).addBox(-16.4375F, 3.6875F, 18.0625F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(10, 14).addBox(-16.4172F, 2.8815F, 20.0857F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(16.125F, 16.8125F, -15.3125F));
		PartDefinition cube_r5 = tail.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(10, 14).addBox(-0.0938F, 0.0313F, -0.2188F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = tail.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(10, 14).addBox(-0.0938F, -0.4688F, -0.2188F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = tail.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(11, 14).addBox(-0.0938F, -0.2813F, -0.4688F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Leftlegs = partdefinition.addOrReplaceChild(
				"Leftlegs", CubeListBuilder.create().texOffs(8, 8).addBox(-14.9375F, -2.0F, 12.6875F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-14.9375F, -2.0F, 16.5625F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(15.3125F, 24.0F, -14.75F));
		PartDefinition Rightlegs = partdefinition.addOrReplaceChild(
				"Rightlegs", CubeListBuilder.create().texOffs(0, 8).addBox(-8.75F, -2.0F, 9.3125F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(4, 8).addBox(-8.75F, -2.0F, 5.4375F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.125F, 24.0F, -7.5F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-16.9375F, -4.25F, 12.5625F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(9, 12)
