...
import net.mcreator.animecross.procedures.SoulReaperUniformBodyTickEventProcedure;
...
public abstract class SoulReaperUniformItem extends ArmorItem {
	public SoulReaperUniformItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends SoulReaperUniformItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(AnimecrossworkspaceModTabs.TAB_BLEACH));
		}
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "animecrossworkspace:textures/entities/base_bleach.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			SoulReaperUniformBodyTickEventProcedure.execute(entity);
		}
	}

	public static class Leggings extends SoulReaperUniformItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(AnimecrossworkspaceModTabs.TAB_BLEACH));
		}
