...
import net.mcreator.animecross.procedures.FireReleaseRightclickedProcedure;
...
public class FireReleaseItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Right click to open skill tree."));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		FireReleaseRightclickedProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
