...
public abstract class JujutsuSourcererItem extends ArmorItem {
	public JujutsuSourcererItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends JujutsuSourcererItem {
		public Chestplate() {
			super(EquipmentSlot.CHEST, new Item.Properties().tab(AnimecrossworkspaceModTabs.TAB_JUJUTSU_KAISEN));
		}
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "animecrossworkspace:textures/entities/sourceroutfit.png";
		}
	}

	public static class Leggings extends JujutsuSourcererItem {
		public Leggings() {
			super(EquipmentSlot.LEGS, new Item.Properties().tab(AnimecrossworkspaceModTabs.TAB_JUJUTSU_KAISEN));
		}
