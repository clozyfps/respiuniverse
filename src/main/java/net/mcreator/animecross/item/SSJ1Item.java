...
import net.mcreator.animecross.procedures.SSJ1RightclickedProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModTabs;

import java.util.List;

public class SSJ1Item extends Item {
	public SSJ1Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Power: 200 Level: 30"));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		SSJ1RightclickedProcedure.execute(entity);
		return ar;
	}
}
