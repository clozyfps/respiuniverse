...
import net.mcreator.animecross.procedures.BigGourdRightclickedProcedure;
...
public class BigGourdItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Increase your breathing with this gourd!"));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BigGourdRightclickedProcedure.execute(entity, itemstack);
		return ar;
	}
}
