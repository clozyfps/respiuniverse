...
public abstract class KimonoItem extends ArmorItem {
	public KimonoItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends KimonoItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "animecrossworkspace:textures/entities/kimono.png";
		}
	}

	public static class Leggings extends KimonoItem {
		public Leggings() {
