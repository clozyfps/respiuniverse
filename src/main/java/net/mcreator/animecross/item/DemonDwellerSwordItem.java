...
import net.mcreator.animecross.procedures.DemonDwellerSwordRightclickedProcedure;
import net.mcreator.animecross.init.AnimecrossworkspaceModTabs;

import java.util.List;

public class DemonDwellerSwordItem extends SwordItem {
	public DemonDwellerSwordItem() {
		super(new Tier() {
			public int getUses() {
				return 99999;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		DemonDwellerSwordRightclickedProcedure.execute(world, entity, ar.getObject());
		return ar;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("The Second Sword Of The Anti - MagicGrimoire."));
	}
