...
public class FireballprojectileItem extends Item {
	public FireballprojectileItem() {
		super(new Item.Properties().tab(null).durability(9999));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				FireballprojectileEntity entityarrow = FireballprojectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
