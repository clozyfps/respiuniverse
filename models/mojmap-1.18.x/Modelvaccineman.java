...
public class Modelvaccineman<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "vaccineman"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = antenna.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.125F, -1.5F, 1.0F, 1.0F, 3.0F,
		...
		PartDefinition cube_r2 = antenna.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(23, 9).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head2 = partdefinition.addOrReplaceChild("Head2", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
