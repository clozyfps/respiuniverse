...
public class Modelwadobite<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wadobite"), "main");
	private final ModelPart wado;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wado = partdefinition.addOrReplaceChild("wado", CubeListBuilder.create().texOffs(6, 17)
				.addBox(-5.25F, -2.325F, -7.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r4 = wado.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(8, 7).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -1.825F, -5.0F, 2.618F, 0.0F, 0.0F));

		PartDefinition cube_r5 = wado.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(12, 0).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -1.825F, -5.0F, 2.0944F, 0.0F, 0.0F));

		PartDefinition cube_r6 = wado.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(6, 12).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -1.825F, -5.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r7 = wado.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(12, 13).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -1.825F, -5.0F, 1.0472F, 0.0F, 0.0F));

		PartDefinition cube_r8 = wado.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(14, 5).addBox(-1.0F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.25F, -1.825F, -5.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition bone = wado.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(6, 0)
				.addBox(-0.5271F, 21.1281F, -1.2233F, 1.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(0.1125F, -33.4088F, -0.5239F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(4, 0).addBox(-0.3875F, -23.2821F, -24.7717F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1021F, 21.4093F, 13.1392F, -0.3927F, 0.0F, 0.0F));
