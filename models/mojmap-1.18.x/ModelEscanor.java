...
public class ModelEscanor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "escanor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone33 = bone32.addOrReplaceChild("bone33", CubeListBuilder.create().texOffs(29, 127)
		...
		PartDefinition bone34 = bone32.addOrReplaceChild("bone34", CubeListBuilder.create().texOffs(29, 127).mirror()
				.addBox(-3.24F, 0.5873F, -3.0839F, 7.0F, 13.0F, 7.0F, new CubeDeformation(-0.88F)).mirror(false)
				.texOffs(0, 45).mirror()
		...
		PartDefinition head_r3 = bone34.addOrReplaceChild("head_r3",
		...
		PartDefinition head_r4 = bone34.addOrReplaceChild("head_r4",
		...
		PartDefinition bone21 = bone32.addOrReplaceChild("bone21", CubeListBuilder.create(),
				PartPose.offset(6.4F, -35.04F, 0.0F));
		...
		PartDefinition bone28 = bone21.addOrReplaceChild("bone28", CubeListBuilder.create(),
		...
		PartDefinition bone6 = bone32.addOrReplaceChild("bone6", CubeListBuilder.create(),
				PartPose.offset(0.0F, -9.52F, 0.0F));

		PartDefinition head = bone6.addOrReplaceChild("head", CubeListBuilder.create().texOffs(137, 227).mirror()
