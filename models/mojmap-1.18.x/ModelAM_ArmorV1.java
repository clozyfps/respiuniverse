...
public class ModelAM_ArmorV1<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(53, 52)
						.addBox(-4.0F, 9.0F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(47, 48)
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(54, 0).addBox(-0.25F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.9604F, 4.1924F, -2.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(49, 53).addBox(-1.0F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8087F, 1.4619F, -2.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(16, 32)
						.addBox(-0.2706F, -1.1533F, -0.5F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(16, 38)
						.addBox(-0.2706F, -1.1533F, 3.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 29)
		...
		PartDefinition cube_r4 = Body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(39, 41)
						.addBox(-0.2929F, -1.2929F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 14)
						.addBox(-0.2929F, -4.2929F, 1.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5723F, 0.6065F, 3.25F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(41, 18).addBox(-2.6316F, -2.9254F, -0.5F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0216F, -1.6097F, 3.75F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r6 = Body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(7, 41).addBox(-1.5F, -2.9142F, -0.5F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(42, 25).addBox(-0.9588F, -4.5566F, -0.5F, 3.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = Body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(34, 3)
						.addBox(-1.8839F, -0.3232F, -1.5F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 18)
		...
		PartDefinition cube_r9 = Body.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(12, 26)
						.addBox(-2.75F, -1.0F, -1.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 51)
						.addBox(-3.75F, -1.0F, -1.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 22)
						.addBox(-4.75F, 1.0F, -1.5F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 53)
						.addBox(-5.75F, 1.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Body.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(30, 0)
						.addBox(-4.4228F, -0.1311F, -1.5F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 23)
		...
		PartDefinition cube_r11 = Body.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(6, 15).addBox(-2.75F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0396F, 8.4424F, -2.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r12 = Body.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(53, 27).addBox(-0.25F, -0.25F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = RightArm.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(31, 50)
						.addBox(-1.75F, -2.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 31)
		...
		PartDefinition cube_r22 = RightArm.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(22, 38).addBox(-0.75F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = RightArm.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(42, 0)
						.addBox(-0.75F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 6)
		...
		PartDefinition cube_r24 = RightArm.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(50, 47)
						.addBox(-0.75F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 51)
						.addBox(-0.75F, 0.0F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r25 = RightArm.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(51, 34)
						.addBox(0.25F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(51, 49)
		...
		PartDefinition cube_r26 = RightArm.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(43, 51).addBox(0.0F, -1.75F, -0.25F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = RightArm.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(51, 45).addBox(0.0F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 1.0F, -1.75F, 0.0F, 0.0F, 0.3927F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(47, 42)
						.addBox(2.0F, 1.0F, -2.25F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(3, 41)
		...
		PartDefinition cube_r28 = LeftArm.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(35, 50)
						.addBox(-1.0F, -2.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(51, 3)
						.addBox(-1.0F, -2.25F, -4.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = LeftArm.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(52, 8)
						.addBox(0.0F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 21)
		...
		PartDefinition cube_r30 = LeftArm.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(52, 12)
						.addBox(-0.75F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 52)
						.addBox(-0.75F, 0.0F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = LeftArm.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(52, 15)
						.addBox(-0.75F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 38)
						.addBox(-0.75F, 0.0F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = LeftArm.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(16, 52)
						.addBox(0.25F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 52)
						.addBox(0.25F, -1.0F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r33 = LeftArm.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(20, 52).addBox(0.0F, -1.75F, -0.25F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.25F, 2.7886F, 0.694F, -0.3927F, 0.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(6, 26)
						.addBox(1.1F, 0.75F, -2.25F, 1.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(12, 11)
						.addBox(-2.15F, 0.75F, -2.25F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition cube_r34 = LeftLeg.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(49, 39)
						.addBox(2.0F, -2.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 50)
		...
		PartDefinition cube_r35 = LeftLeg.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(50, 0)
						.addBox(-0.3827F, -1.6739F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 30)
		...
		PartDefinition cube_r36 = LeftLeg.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(4, 50).addBox(-0.8483F, -2.0196F, -0.25F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = LeftLeg.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(50, 25).addBox(-0.75F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r38 = LeftLeg.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(24, 22)
						.addBox(-0.5F, -4.0F, -0.5F, 1.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(34, 25)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(24, 0)
						.addBox(1.15F, 0.75F, -2.25F, 1.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.1F, 0.75F, -2.25F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition cube_r39 = RightLeg.addOrReplaceChild("cube_r39",
				CubeListBuilder.create().texOffs(49, 13)
						.addBox(-0.5F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(49, 36)
		...
		PartDefinition cube_r40 = RightLeg.addOrReplaceChild("cube_r40",
				CubeListBuilder.create().texOffs(49, 19)
						.addBox(-1.8827F, -2.4239F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 26)
						.addBox(-0.8827F, -1.1739F, -4.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r41 = RightLeg.addOrReplaceChild("cube_r41",
				CubeListBuilder.create().texOffs(23, 49).addBox(-0.8483F, -2.0196F, -0.25F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r42 = RightLeg.addOrReplaceChild("cube_r42",
				CubeListBuilder.create().texOffs(49, 28).addBox(-0.75F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r43 = RightLeg.addOrReplaceChild("cube_r43",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(-0.5F, -4.0F, -0.5F, 1.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
						.addBox(-0.5F, -4.0F, 2.75F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)),
