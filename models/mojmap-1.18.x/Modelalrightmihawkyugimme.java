...
public class Modelalrightmihawkyugimme<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "alrightmihawkyugimme"), "main");
	...
	private final ModelPart howie;
	private final ModelPart huzz;
	private final ModelPart bone;
	private final ModelPart hexfou;
	private final ModelPart hexadecagonf;
	private final ModelPart hexadecagonff;
	private final ModelPart hexadecagons;
	private final ModelPart hexadecagonss;
	private final ModelPart hexadecagone;
	private final ModelPart hexadecagonn;
	private final ModelPart bowie;
	private final ModelPart hexadecagont;
	private final ModelPart hexadecagoneeee;
	private final ModelPart hexadecagontweel;
	private final ModelPart hexadecagonthirtt;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition howie = partdefinition.addOrReplaceChild("howie",
				CubeListBuilder.create().texOffs(11, 87)
						.addBox(-3.5913F, -2.5F, -6.0F, 3.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(11, 87)
						.addBox(-10.0F, -2.5F, 0.4087F, 16.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.1875F, -2.875F, -2.0625F));

		PartDefinition hexadecagon_r1 = howie.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(11, 87)
						.addBox(-8.0F, -0.5F, -1.5913F, 16.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(11, 87)
		...
		PartDefinition hexadecagon_r3 = howie.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(7, 80).addBox(-1.5913F, -0.5F, -8.0F, 3.0F, 0.0F, 16.0F,
		...
		PartDefinition hexadecagon_r4 = howie.addOrReplaceChild("hexadecagon_r4",
				CubeListBuilder.create().texOffs(11, 87).addBox(-1.5913F, -0.5F, -8.0F, 3.0F, 0.0F, 16.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition huzz = partdefinition.addOrReplaceChild("huzz",
				CubeListBuilder.create().texOffs(42, 4)
						.addBox(-0.5F, -0.3978F, -2.0F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(42, 4)
		...
		PartDefinition cube_r1 = huzz.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(81, 85).addBox(-0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = huzz.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(84, 90).addBox(5.875F, 6.1875F, -0.0625F, 1.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r5 = huzz.addOrReplaceChild("hexadecagon_r5",
				CubeListBuilder.create().texOffs(42, 4)
						.addBox(-0.5F, -2.0F, -0.3978F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(42, 4)
						.addBox(-0.5F, 1.6F, -0.3978F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(42, 4)
						.addBox(-0.5F, -0.3978F, 1.6F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(42, 4)
		...
		PartDefinition handle = Mihawkssword.addOrReplaceChild("handle", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition hexadecagonsec = handle.addOrReplaceChild("hexadecagonsec", CubeListBuilder.create()
				.texOffs(18, 117).addBox(13.6505F, -1.3018F, -20.1009F, 0.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(18, 117).addBox(13.25F, -1.3018F, -19.7003F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r9 = hexadecagonsec.addOrReplaceChild("hexadecagon_r9", CubeListBuilder.create()
				.texOffs(18, 117).addBox(4.6785F, -7.3018F, -23.5279F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r10 = hexadecagonsec.addOrReplaceChild("hexadecagon_r10", CubeListBuilder.create()
				.texOffs(18, 117).addBox(19.7282F, -7.3018F, -13.0041F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r11 = hexadecagonsec.addOrReplaceChild("hexadecagon_r11",
				CubeListBuilder.create().texOffs(18, 117).addBox(-4.2808F, -7.3018F, -24.1268F, 0.0F, 6.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r12 = hexadecagonsec.addOrReplaceChild("hexadecagon_r12",
				CubeListBuilder.create().texOffs(18, 117).addBox(23.5274F, -7.3018F, -4.6814F, 0.0F, 6.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 6.0F, 0.0625F, 0.0F, 0.7854F, 0.0F));

		PartDefinition hexadecagonthird = handle.addOrReplaceChild("hexadecagonthird", CubeListBuilder.create()
				.texOffs(35, 120).addBox(13.6505F, 4.9482F, -20.1009F, 0.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(35, 120).addBox(13.25F, 4.9482F, -19.7003F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition hexadecagon_r13 = hexadecagonthird.addOrReplaceChild("hexadecagon_r13", CubeListBuilder.create()
				.texOffs(35, 120).addBox(4.6785F, -7.3018F, -23.5279F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r14 = hexadecagonthird.addOrReplaceChild("hexadecagon_r14", CubeListBuilder.create()
				.texOffs(35, 120).addBox(19.7282F, -7.3018F, -13.0041F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
		...
		PartDefinition hexadecagon_r15 = hexadecagonthird.addOrReplaceChild("hexadecagon_r15",
				CubeListBuilder.create().texOffs(35, 120).addBox(-4.2808F, -7.3018F, -24.1268F, 0.0F, 0.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r16 = hexadecagonthird.addOrReplaceChild("hexadecagon_r16",
				CubeListBuilder.create().texOffs(35, 120).addBox(23.5274F, -7.3018F, -4.6814F, 0.0F, 0.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.25F, 0.0625F, 0.0F, 0.7854F, 0.0F));

		PartDefinition Hilt = Mihawkssword.addOrReplaceChild("Hilt", CubeListBuilder.create().texOffs(104, 117)
				.addBox(13.1875F, -1.9893F, -24.5384F, 1.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Hilt.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, 10.9027F, -16.65F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.9709F, 5.0131F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r4 = Hilt.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, 4.1245F, -19.7804F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.9709F, 5.0131F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Hilt.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, -9.8071F, -17.8098F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.9084F, 5.0131F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r6 = Hilt.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, 12.5349F, -15.1303F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.9084F, 5.0131F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Hilt.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, 11.7872F, -16.021F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.0669F, -4.9542F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Hilt.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, 4.7298F, -19.5806F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.6875F, -4.5625F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r9 = Hilt.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, -15.771F, -12.5372F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.5153F, -5.0514F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r10 = Hilt.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(104, 117).addBox(13.1875F, -10.2574F, -17.565F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.1875F, -4.625F, 0.3927F, 0.0F, 0.0F));

		PartDefinition blade = Mihawkssword.addOrReplaceChild("blade", CubeListBuilder.create().texOffs(78, 120)
				.addBox(5.4F, -14.5518F, -11.9134F, 0.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 8.0F, -8.0F));

		PartDefinition mainblade = blade.addOrReplaceChild("mainblade", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition spart = blade.addOrReplaceChild("spart", CubeListBuilder.create(),
				PartPose.offset(-8.0F, -8.0F, 8.0F));

		PartDefinition thpart = blade.addOrReplaceChild("thpart", CubeListBuilder.create(),
				PartPose.offset(-8.0F, -8.0F, 8.0F));

		PartDefinition group = Mihawkssword.addOrReplaceChild("group", CubeListBuilder.create().texOffs(110, 73)
				.addBox(13.225F, -17.9518F, -18.7134F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(110, 73)
				.addBox(13.225F, -10.7518F, -18.2384F, 0.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(110, 73)
		...
		PartDefinition groups = Mihawkssword.addOrReplaceChild("groups", CubeListBuilder.create().texOffs(110, 100)
				.addBox(13.375F, -10.7518F, -16.5384F, 0.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(110, 100)
				.addBox(13.375F, -13.4518F, -16.6884F, 0.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(110, 100)
		...
		PartDefinition groupt = Mihawkssword.addOrReplaceChild("groupt", CubeListBuilder.create().texOffs(110, 97)
				.addBox(13.5F, -10.7518F, -16.3384F, 0.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(110, 97)
				.addBox(13.5F, -13.4518F, -16.4884F, 0.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(110, 97)
		...
		PartDefinition hexfou = partdefinition.addOrReplaceChild("hexfou",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.6875F, 12.4375F, -6.25F));

		PartDefinition hexadecagon_r17 = hexfou.addOrReplaceChild("hexadecagon_r17",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-0.8F, -0.3F, -0.0597F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
		...
		PartDefinition hexadecagon_r19 = hexfou.addOrReplaceChild("hexadecagon_r19",
				CubeListBuilder.create().texOffs(35, 121).addBox(-0.8F, -0.0597F, -0.3F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagonf = partdefinition.addOrReplaceChild("hexadecagonf",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagonff = partdefinition.addOrReplaceChild("hexadecagonff",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagons = partdefinition.addOrReplaceChild("hexadecagons",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagonss = partdefinition.addOrReplaceChild("hexadecagonss",
				CubeListBuilder.create().texOffs(35, 121)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 121)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagone = partdefinition.addOrReplaceChild("hexadecagone",
				CubeListBuilder.create().texOffs(56, 111)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 111)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.75F, 15.1875F, -6.8125F));

		PartDefinition hexadecagon_r37 = hexadecagone.addOrReplaceChild("hexadecagon_r37",
				CubeListBuilder.create().texOffs(56, 111)
						.addBox(-0.8F, -0.3F, -0.0597F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 111)
						.addBox(-0.8F, -0.0597F, -0.3F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagon_r39 = hexadecagone.addOrReplaceChild("hexadecagon_r39",
				CubeListBuilder.create().texOffs(56, 111).addBox(-0.8F, -0.0597F, -0.3F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagonn = partdefinition.addOrReplaceChild("hexadecagonn",
				CubeListBuilder.create().texOffs(56, 111)
						.addBox(-2.8F, -2.0597F, 1.7F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 111)
						.addBox(-2.8F, -2.3F, 1.9403F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bowie = partdefinition.addOrReplaceChild("bowie",
				CubeListBuilder.create().texOffs(56, 116)
						.addBox(-2.8F, -2.0298F, 1.85F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 116)
						.addBox(-2.8F, -2.15F, 1.9702F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.6875F, 13.25F, -6.4375F));

		PartDefinition hexadecagon_r45 = bowie.addOrReplaceChild("hexadecagon_r45",
				CubeListBuilder.create().texOffs(56, 116)
						.addBox(-0.8F, -0.15F, -0.0298F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 116)
						.addBox(-0.8F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagon_r47 = bowie.addOrReplaceChild("hexadecagon_r47",
				CubeListBuilder.create().texOffs(56, 116).addBox(-0.8F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagont = partdefinition.addOrReplaceChild("hexadecagont",
				CubeListBuilder.create().texOffs(111, 80)
						.addBox(-2.8F, -2.0298F, 1.85F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(111, 80)
						.addBox(-2.8F, -2.15F, 1.9702F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.75F, 15.6875F, -6.9375F));

		PartDefinition hexadecagon_r49 = hexadecagont.addOrReplaceChild("hexadecagon_r49",
				CubeListBuilder.create().texOffs(111, 80)
						.addBox(-0.8F, -0.15F, -0.0298F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(111, 80)
						.addBox(-0.8F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagon_r51 = hexadecagont.addOrReplaceChild("hexadecagon_r51",
				CubeListBuilder.create().texOffs(111, 80).addBox(-0.8F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagoneeee = partdefinition.addOrReplaceChild("hexadecagoneeee",
				CubeListBuilder.create().texOffs(111, 80)
						.addBox(-2.8F, -2.0298F, 1.85F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(111, 80)
						.addBox(-2.8F, -2.15F, 1.9702F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagontweel = partdefinition.addOrReplaceChild("hexadecagontweel",
				CubeListBuilder.create().texOffs(56, 116)
						.addBox(-2.8F, -2.0298F, 1.85F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 116)
						.addBox(-2.8F, -2.15F, 1.9702F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagonthirtt = partdefinition.addOrReplaceChild("hexadecagonthirtt",
				CubeListBuilder.create().texOffs(36, 118)
						.addBox(-2.2F, -2.0298F, 1.85F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(36, 118)
						.addBox(-2.2F, -2.15F, 1.9702F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 12.25F, -7.375F));

		PartDefinition hexadecagon_r61 = hexadecagonthirtt.addOrReplaceChild("hexadecagon_r61",
				CubeListBuilder.create().texOffs(36, 118)
						.addBox(-0.2F, -0.15F, -0.0298F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(36, 118)
						.addBox(-0.2F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.3927F, 0.0F, 0.0F));
		...
		PartDefinition hexadecagon_r63 = hexadecagonthirtt.addOrReplaceChild("hexadecagon_r63",
				CubeListBuilder.create().texOffs(36, 118).addBox(-0.2F, -0.0298F, -0.15F, 1.0F, 0.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(34, 0)
						.addBox(-4.4375F, -34.0F, -4.5625F, 3.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(34, 0)
		...
		PartDefinition cube_r11 = bb_main.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(92, 13).addBox(-1.0F, -0.8125F, 0.5625F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = bb_main.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(92, 13).addBox(-1.0F, -0.5F, -2.3125F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = bb_main.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(92, 13).addBox(-1.0F, -0.9375F, -1.8125F, 2.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
