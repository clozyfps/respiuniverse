...
public class Modelmihawkdrippworkrn<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mihawkdrippworkrn"), "main");
	...
	public Modelmihawkdrippworkrn(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon = Body.addOrReplaceChild("hexadecagon",
		...
		PartDefinition hat = partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(92, 13)
				.addBox(2.9375F, -1.7343F, -6.0393F, 2.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(11, 87)
				.addBox(-2.9663F, 0.7032F, -9.5393F, 3.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(11, 87)
