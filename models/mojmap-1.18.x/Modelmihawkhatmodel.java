...
public class Modelmihawkhatmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mihawkhatmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hat = bone.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(34, 0)
				.addBox(-4.125F, -24.5F, -5.3125F, 8.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 18)
		...
		PartDefinition cube_r1 = hat.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(12, 30).addBox(-1.0F, 1.375F, 0.0F, 2.0F, 2.0F, 6.0F,
		...
		PartDefinition cube_r2 = hat.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(28, 30).addBox(-1.0F, 1.375F, -5.4375F, 2.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.5F, -22.1875F, 12.625F, -0.4189F, 0.0F, 0.0F));

		PartDefinition cube_r3 = hat.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 25).addBox(-4.0F, -9.8125F, 1.5F, 8.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = hat.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(18, 25)
						.addBox(-0.3125F, -2.0F, 12.1875F, 10.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 13)
						.addBox(-0.3125F, -2.0F, 3.4375F, 10.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon = hat.addOrReplaceChild("hexadecagon",
				CubeListBuilder.create().texOffs(0, 33)
						.addBox(-8.3125F, -1.5913F, -8.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(19, 3)
		...
		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-8.3125F, -8.0F, -1.5913F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
		...
		PartDefinition hexadecagon_r2 = hexadecagon.addOrReplaceChild("hexadecagon_r2",
				CubeListBuilder.create().texOffs(0, 8)
						.addBox(-8.3125F, -8.0F, -1.5913F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(14, 10)
		...
		PartDefinition hexadecagon_r3 = hexadecagon.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(14, 13)
						.addBox(-8.3125F, -1.5913F, 5.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(22, 30)
						.addBox(-8.3125F, -1.5913F, -8.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r4 = hexadecagon.addOrReplaceChild("hexadecagon_r4",
				CubeListBuilder.create().texOffs(28, 27)
						.addBox(-8.3125F, -1.5913F, 5.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 2)
						.addBox(-8.3125F, -1.5913F, -8.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
