...
public class Modelpochitaentyty<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "pochitaentyty"), "main");
	private final ModelPart Pochita;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Pochita = partdefinition.addOrReplaceChild("Pochita", CubeListBuilder.create(),
				PartPose.offset(7.25F, 15.875F, -15.3125F));

		PartDefinition Body2 = Pochita.addOrReplaceChild("Body2", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-12.6875F, -11.25F, 8.5625F, 12.0F, 10.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
				.addBox(-0.6875F, -15.6875F, 13.3125F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(1, 61)
		...
		PartDefinition cube_r1 = Body2
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(30, 43).addBox(-7.0F, -30.0F, -7.0F, 1.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body2
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(30, 43).addBox(-7.0F, -12.0F, 25.0F, 1.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Body2
				.addOrReplaceChild("cube_r3",
						CubeListBuilder.create().texOffs(30, 43).addBox(-7.0F, 1.0F, 28.0F, 1.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition Legs = Pochita.addOrReplaceChild("Legs",
				CubeListBuilder.create().texOffs(9, 2)
						.addBox(-2.625F, -2.0F, 8.5625F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 0)
		...
		PartDefinition Chainsaw = Pochita.addOrReplaceChild("Chainsaw",
				CubeListBuilder.create().texOffs(46, 0)
						.addBox(-7.5F, -11.1875F, -5.25F, 1.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 52)
		...
		PartDefinition cube_r4 = Chainsaw.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 52).addBox(-0.5F, -0.3125F, -2.0F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Chainsaw.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 52).addBox(-0.5F, -0.125F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Chainsaw.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 52).addBox(-0.4375F, -0.1875F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Chainsaw.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 52).addBox(-0.5F, -0.125F, -0.6875F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon = Chainsaw.addOrReplaceChild("hexadecagon",
				CubeListBuilder.create().texOffs(57, 0)
						.addBox(-2.25F, -2.2984F, 0.5F, 1.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(57, 0)
						.addBox(-2.25F, -3.5F, 1.7016F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.1875F, -7.6875F, -7.6875F));

		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1",
				CubeListBuilder.create().texOffs(57, 0)
						.addBox(-0.25F, -1.5F, -0.2984F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(57, 0)
		...
		PartDefinition hexadecagon_r3 = hexadecagon.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(57, 0).addBox(-0.25F, -0.2984F, -1.5F, 1.0F, 0.0F, 3.0F,
						new CubeDeformation(0.0F)),
