...
public class ModelGoddessClanWings<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Wings.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(11, 68).addBox(-0.9043F, -2.6606F, -0.8536F, 2.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.7686F, -15.8059F, -0.7554F, -0.3927F, 0.0F, 0.3927F));

		PartDefinition cube_r2 = Wings.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-0.9043F, -7.6304F, -0.7446F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(52, 29)
				.addBox(-0.9043F, -1.6304F, -3.9946F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = Wings.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(17, 68).addBox(-1.287F, -1.8071F, -0.5F, 2.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Wings.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(34, 53)
						.addBox(-1.75F, -1.5F, -4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
		...
		PartDefinition cube_r5 = Wings.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(24, 16)
						.addBox(7.574F, -16.6358F, 0.0F, 14.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 35)
						.addBox(5.574F, -14.6358F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.9018F, -20.3294F, -0.5F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r6 = Wings.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(44, 58).addBox(-1.1173F, -2.9239F, -1.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Wings.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(48, 0)
						.addBox(0.4697F, -14.4194F, 0.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(24, 57)
		...
		PartDefinition cube_r8 = Wings.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(52, 12).addBox(-2.0756F, -9.6369F, -1.0F, 2.0F, 10.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = Wings.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(12, 32).addBox(-2.25F, -1.75F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = Wings.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(8, 60).addBox(-1.9239F, -0.8827F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = Wings.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(36, 59).addBox(4.9429F, -21.037F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = Wings.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(42, 52).addBox(-2.0F, 0.25F, -1.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = Wings.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 48)
						.addBox(-9.1768F, -14.773F, 0.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(30, 57)
		...
		PartDefinition cube_r14 = Wings.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(16, 52).addBox(0.4022F, -9.7722F, -1.0F, 2.0F, 10.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = Wings.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(28, 36).addBox(0.0F, -4.5F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = Wings.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(60, 12).addBox(-0.4984F, -0.749F, -1.0F, 2.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = Wings.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 60).addBox(-0.4697F, -1.7981F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = Wings.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(64, 57)
						.addBox(-5.926F, 1.1142F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(62, 65)
		...
		PartDefinition cube_r19 = Wings.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(60, 29)
						.addBox(15.9268F, 10.4874F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(62, 61)
						.addBox(12.9268F, 12.4874F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(7, 63)
		...
		PartDefinition Wings2 = Body.addOrReplaceChild("Wings2", CubeListBuilder.create(),
				PartPose.offset(0.0F, 17.5F, 4.0F));

		PartDefinition cube_r20 = Wings2.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(44, 0).addBox(-0.4522F, -1.8303F, -0.4268F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.3843F, -6.6529F, -1.6277F, -0.3927F, 0.0F, 0.3927F));

		PartDefinition cube_r21 = Wings2.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(0, 16)
				.addBox(-0.4522F, -3.8152F, -0.3723F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(54, 35)
				.addBox(-0.4522F, -0.8152F, -0.9973F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = Wings2.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(44, 36).addBox(-0.6435F, -1.4035F, -0.25F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = Wings2.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(28, 57)
						.addBox(-0.875F, -0.75F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 36)
		...
		PartDefinition cube_r24 = Wings2.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(24, 52)
						.addBox(3.787F, -8.3179F, 0.0F, 7.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(20, 16)
		...
		PartDefinition cube_r25 = Wings2.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(58, 12).addBox(-1.0587F, -0.9619F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = Wings2.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(56, 49)
						.addBox(0.2348F, -7.2097F, 0.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
		...
		PartDefinition cube_r27 = Wings2.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(50, 60).addBox(-1.0378F, -4.8184F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = Wings2.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(6, 60).addBox(-1.125F, -0.875F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = Wings2.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(69, 56).addBox(-0.9619F, -0.9413F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = Wings2.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(70, 53).addBox(2.4715F, -10.5185F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r31 = Wings2.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(48, 12).addBox(-1.5F, -0.375F, -0.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r32 = Wings2.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(56, 55)
						.addBox(-4.5884F, -7.3865F, 0.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 0)
		...
		PartDefinition cube_r33 = Wings2.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(58, 61).addBox(0.2011F, -4.8861F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r34 = Wings2.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(57, 70).addBox(0.0F, -2.25F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r35 = Wings2.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(70, 58).addBox(-0.2492F, -0.8745F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r36 = Wings2.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(70, 67).addBox(-0.2348F, -0.899F, -0.5F, 1.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r37 = Wings2.addOrReplaceChild("cube_r37",
				CubeListBuilder.create().texOffs(52, 29)
						.addBox(-2.963F, 0.0571F, -0.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(70, 9)
		...
		PartDefinition cube_r38 = Wings2.addOrReplaceChild("cube_r38",
				CubeListBuilder.create().texOffs(31, 64)
						.addBox(7.9634F, 4.7437F, -0.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 67)
